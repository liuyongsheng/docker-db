...
| 镜像 | 基础镜像 | 瘦身手段 |
|------|----------|----------|
| `liuys36/mysql:8.0-slim` | `mysql:8.0` | 删除 mysqlsh (460MB)、RPM/dpkg/perl/debug/locale 等 |
| `liuys36/mssql:2017-slim` | `softwareplant/mssql:clean-2017-mcr-jira-9-arm64` | 删除 Jira 残留 (278MB)、Python/debug/apt 等 |
...
docker build --platform linux/amd64 -t liuys36/dm8:20260427-slim -f Dockerfile.dm8 .
```
